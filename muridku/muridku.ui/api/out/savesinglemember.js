...
export const savesinglemember = (ktb_id, member_id, email, name, gender, city_id, address, birth_dt, birth_place, mobile_phn, inst_type, institution_id, faculty_id, usr, callback, errorHandler) => {
