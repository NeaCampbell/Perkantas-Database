...
CREATE TABLE `logapi` (
  ...
  `dtm_crt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=42827 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
	...
	ELSE
		CALL muridku.`UpdateSingleMember`(`email`, `member_id_param`, `name`, `city_id_param`, `address`, birth_dt_param, birth_place, mobile_phn, inst_type, institution_id_param, faculty_id_param, usr) ;
    END IF ;
...
-- Dump completed on 2021-07-31 10:26:45
